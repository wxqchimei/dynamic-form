...
public class FormEditTag extends TagSupport {
        ...
        try {
            ...
            stringWriter
                    .write("<script type=\"text/javascript\">"
                            +"var renderDynamicForm = function(formId,entityName,entityId,callback){"
                            +"$.post(\"" + DynamicFormServer.BASE_PATH
                                    + "back/dynamicForm/showEditForm.do\", {formId:formId,entityName : entityName,entityId:entityId"
                            +"}, function(framgetHtml) {$(\""+containerId+"\").html(framgetHtml);if(callback){callback();}}, \"html\");};"
    ...
    private String getAsynHtml() {
        ...
        content.append("$.post(\"" + DynamicFormServer.BASE_PATH
                + "back/dynamicForm/showEditForm.do\", {formId:formId,entityName : entityName");
        content.append(",entityId:entityId");
