 ...
 * @date 2016年7月15日
 */
public class FormAddTag extends TagSupport {
    /**
     * 
     */
    ...
    private String getStaticHtml() {
        ...
        try {
            form.displayAddHtml(stringWriter);
    ...
    private String getAsynHtml() {
        ...
        content.append(
                "var renderDynamicForm = function(currentFormId,callback){if (!currentFormId){return;};");
        ...
        content.append("var collecteDynamicField = function(){" + "var customs = {};"
                //TODO
                + " $(\"[name^='"+DynamicFormServer.DYNAMICFIELDHTTPPARAMETERPREFIX+"']\").each(function(i,e){"
                + "   var name = $(this).attr(\"name\");" + " var val = $(this).val();"
                + "customs[name]=val;});return customs;};");
